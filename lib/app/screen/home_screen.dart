...
class _HomeScreenState extends State<HomeScreen>
  ...
  final List<GoodsTab> myTabs = <GoodsTab>[
    new GoodsTab('特惠', new GoodList(listType: '132')),
    new GoodsTab('大额券', new GoodList(listType: '564')),
    new GoodsTab('品牌券', new GoodList(listType: 'guonei')),
    new GoodsTab('天猫满减', new GoodList(listType: 'caijing'))
  ];
