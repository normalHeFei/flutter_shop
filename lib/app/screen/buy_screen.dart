...
class _BuyScreenState extends State<BuyScreen> {
        ...
        showDialog(
            ...
            builder: (_) {
              return AlertDialog(
                  ...
                  actions: <Widget>[
                    new FlatButton(
                      child: new Text("我是按钮1"),
                      onPressed: () {
                        Navigator.of(context).pop();
                      },
                    ),
                    new FlatButton(
                      child: new Text("我是按钮2"),
                      onPressed: () {
                        Navigator.of(context).pop();
                      },
                    )
  ...
  Widget _widget_body() {
    // 整体内容 cloumn 用于控制 生成 Widget 子组件
    List<Widget> cols = [];
